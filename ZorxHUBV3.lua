...
-- ===== NOTIFICATION SYSTEM V5 (STACK TOP DOWN + RANDOM EXP) =====
...
local function updatePositions()
    for i,frame in ipairs(activeNotifs) do
        frame:TweenPosition(
            UDim2.new(0.5, 0, 0.1 + ((i-1)*0.07), 0),
...
local function zorxNotif(text, duration)
    ...
    while #notifQueue > 0 do
        ...
        frame.Position = UDim2.new(0.5, 0, -0.2, 0) -- dari atas
...
-- LOP DASH
addBtn("💨 LOP DASH", staffScroll, function()
    zorxNotif("Lop Dash Loading...")
    ...
    zorxNotif("Lop Dash Activated 💨")
end)

-- AUTO BLOCK
addBtn("🛡️ AUTO BLOCK", staffScroll, function()
    zorxNotif("Auto Block Loading...")
...
zorxNotif("[👑] Owner Has Arrived...", 6)
zorxNotif("Welcome Back, Master ZORXHUB", 6)
zorxNotif("All Systems Loaded Successfully", 6)
zorxNotif("Authority: FULL ACCESS GRANTED", 6)
zorxNotif("Dominate The Server", 6)